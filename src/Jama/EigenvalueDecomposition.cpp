	  ...
	  for (int l = 0; l < n; l++) {
		 ...
		 if (m > l) {
			...
			do {
			   ...
			   double r = jama::util::Maths::hypot(p,1.0);
			   if (p < 0) {
				  r = -r;
			   }
			   d[l] = e[l] / (p + r);
...
double* EigenvalueDecomposition::getImagEigenvalues () {
	  return e;
   }   
...
double* EigenvalueDecomposition::getRealEigenvalues () {
	  return d;
   }   
/* ------------------------
   Public Methods
